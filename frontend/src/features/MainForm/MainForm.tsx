...
export default function MainForm() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <h1 className="text-3xl font-bold">Generate a Portfolio Website</h1>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          <FormInput
            ...
            placeholder="e.g. Software Engineer, DevOps Engineer, Engineering Manager"
            description="Write multiple titles, each separated by a comma"
          />
          <FormInput
            name="icons"
            label="FontAwesome Icons for Professional Titles: "
          />
